...
const navItems = [
  ...
  { href: "/bot-flows", label: "Bot Flows", icon: Bot, color: "text-emerald-400" },
  { href: "/analytics", label: "Analytics", icon: ChartLine, color: "text-blue-400" },
  ...
  { href: "/settings/taxonomy", label: "Taxonomy", icon: Tags, color: "text-indigo-500" },
];
